...
export interface RelationshipEdge {
  ...
  from: { entityId: string; entityType: EntityType };
  to: { entityId: string; entityType: EntityType };
...
export const RELATIONSHIPS_BY_CATEGORY: Record<
...
export const CORE_RELATIONSHIP_CONSTRAINTS: Array<{
  from: EntityType;
  type: RelationshipType;
  to: EntityType;
}> = [
